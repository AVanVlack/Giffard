...
function Categories() {
	return (
		<div className="categoriesComponent">
			<div class="row small-up-1 medium-up-2 large-up-3 categories">
				<div class="column">
					<div class="cat-item">
				...
				<div class="column">
					<div class="cat-item">
						<img src="https://media.giphy.com/media/CBl5I5d0YFUsw/giphy.gif" />
						<h3>Reactions</h3>
					</div>
				</div>
				<div class="column">
					<div class="cat-item">
						<img src="https://media.giphy.com/media/l41lXwNetL7oWLrd6/giphy.gif" />
						<h3>Actions</h3>
					</div>
				</div>
				<div class="column">
					<div class="cat-item">
						<img src="https://media.giphy.com/media/13S2y4dF6TPxHW/giphy.gif" />
						<h3>TV/Media</h3>
					</div>
				</div>
				<div class="column">
					<div class="cat-item">
						<img src="https://media.giphy.com/media/YgmczzYWY4DTO/giphy.gif" />
						<h3>Music</h3>
					</div>
				</div>
				<div class="column">
					<div class="cat-item">
						<img src="https://media.giphy.com/media/xT1XGS8p8GZ0RqN7J6/giphy.gif" />
						<h3>Art</h3>
					</div>
				</div>
				<div class="column">
				...
				<div class="column">
					<div class="cat-item">
						<img src="https://media.giphy.com/media/w0CJXS2M44xfW/giphy.gif" />
						<h3>Funny</h3>
					</div>
				</div>
				<div class="column">
